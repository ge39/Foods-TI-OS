    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ['Grupo de Lojas Atendidas', 'Total'],
          <?php foreach ($var_loja as $loja1) { ?>
          ['<?php echo $loja1['loja'];?>', <?php echo $loja1['cal_loja'];?>,],
         <?php } ?>
        ]);
        ...
        var options = {
          ...
          chart: { title: '',
                   subtitle: 'Inclui chamados Remotos e Externos' },
          bars: 'vertical', // Required for Material Bar Charts.
          axes: {
            x: {
              1: { side: 'top', label: ''} // Top x-axis.
            }
          },
          bar: { groupWidth: "10%" }
        };
      ...
      <div style="color: gray;font-size: 14px;">
        ...
        <div class="resultado">
          <?php foreach ($var_total_loja as $total) { ?>
               <div class="nome"><?php echo  " Total ". $total['calc_loja']." atendimentos";?>     
               </div>
               
         <?php } ?>
         <?php foreach ($var_qtde_loja as $qtde) { ?>
               <div class="nome"><?php echo  " Total ". $qtde['calc_loja']." lojas atendidas";?>     
               </div>

...
<html>
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ['Data', 'Total'],
          <?php foreach ($var_dia as $dia) { ?>
            ['<?php echo $dia['data_fecha_chamado'];?>', <?php echo $dia['total'];?>,],
         <?php } ?>
        ]);
  ...
  <body>
      ...
      <div style="color: gray;font-size: 14px;">
       ...
       <div class="resultado">
        <?php foreach ($var_total_dia as $dia) { ?>
           <div class="nome"><?php echo  " Total ". $dia['total']." atendimentos";?> 
        <?php } ?>

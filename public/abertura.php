<?php
	...
	require_once('../template/chamado.php');
?>
...
<div class="container">
	<form action="../persistence/crud.php" method="GET">
		<div class="loja">
			<label>Loja</label><br>
			<select class="select" required="required" name="id">
				<option></option>
		...
		<div class="tecnico" >
			...
			<select class="select" required="required" name="id_tecnico">
			 <option value="12">Validando</option>
		...
		<div class="prioridade">
			...
			<select class="select" required="required" name="id_priore">
		...
		<div class="data">
			...
			<select required="" name="atendimento" style="width: 190px;">
				<option></option>
		...
		<div class="solicitacao">
			...
			<input text=""class="input" required = "" name ="defeito_reclamado" placeholder="Descreva as informações passadas pelo usuario" maxlength="76"></textarea>
		</div>
		<div>

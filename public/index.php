...
?>
 ...
 <div class="filtro">
 	<div class="filtro_opt"></div>
 	<div class="filtro_button"></div>
 </div>
 <div class="container">
		<div class="header">
			<div class="H0">ID - AT</div>
			<div class="H1">Loja</div>
            <div class="H9">Regiao</div>
	...
	<div>
		<?php foreach ($var_select_all as $row) {?>
			...
			<div class="id">
				...
				<?php echo '<div class="label">Atend:</div>'." ".$row['descricao'];?>
			</div>
            ...
            <div class="regiao">
				<?php echo '<div class="label">Regiao:  </div>'." ".$row['regiao']?>
			</div>
			<div class="criador">
				 <?php echo $row['criado'];
				?>
			...
			<div class="abertura">
				<?php echo '<div class="label">Chamado Aberto: </div>'." ".date('d/m/Y H:i', strtotime($row['data_abertura_chamado']));?>
			</div>
			
			<div class="abertura">
				<?php 
					if(($row['ultima_atualizacao']) == '0000-00-00 00:00:00'){
						echo '<div class="label">Ultima Atualizado: </div>'." ".'00/00/0000 00:00';
					}
					else{
						echo '<div class="label">Ultima Atualizado: </div>'." ".date('d/m/Y H:i', strtotime($row['ultima_atualizacao']));
					}
				?>
			</div>

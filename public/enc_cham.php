...
<div class="container">
	<form action="../persistence/crud.php" method="get">
		<?php foreach ($var_select as $row) {?>			
			...
			<div class="id">
				<label>Data</label><br>
				<input class="input" type="text" name="" value="<?php echo date('d/m/Y H:m', strtotime($row['data_abertura_chamado']));?>" readonly>
			</div>
			<div class="loja">
				<label>Loja</label><br>
			...
			<div class="tecnico">
                   ...
                   <label>Técnico</label><br>
                    <div style="background-color:red;color:white;padding: 2px;margin:2px;">
                    	<?php echo $_GET['mensagem'];?>
                    </div> 
				<select name="id_tecnico">      
                    <option value="<?php echo $row['id_tecnico'];?>"><?php echo ($_SESSION['nome']);?></option>
					
					<?php foreach ($var_tec as $tecnico) { ?>
						<option value ="<?php echo $tecnico['id'];?>"><?php echo $tecnico['nome'];?> <?php } ?>
						</option>
				</select>
			</div>
			...
			<div class="data">
				...
				<input class="input" type="text" readonly name="data_fechamento" value="<?php echo $date;?>">
			</div>
			...
			<div class="equipamento">
				<label>Equipamento com defeito</label></br>
				
				<select name="equipamento" required="" style = "width: 210px">
					<option></option>
					<?php foreach($var_equipamento as $equip) { ?>
						<option value="<?php echo $equip['id_equip'];?>"><?php echo $equip['desc_equip'];?> <?php } ?>
						</option>
			...
			<div class="mensagem">
				...
				<textarea  class="input" name = "solucao" cols="4" rows="5" maxlength = "7500" required=""><?php echo $row['solucao'];?></textarea>
			</div>
			...
			<div class="atendimento">
				...
				<select class="atend_select" required="" name="cod_atend">

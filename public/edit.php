...
<div class="container">
	...
	<form action="../persistence/crud.php" method="get">
		<?php foreach ($var_select as $row) {?>	
			...
			<div class="id">
				...
				<input class="input" type="text" name="" readonly value="<?php echo date('d/m/Y H:i', strtotime($row['data_abertura_chamado']));?>" readonly>
			</div>
			<div class="loja">
				<label>Loja</label><br>
				<select name="id_loja" required="" style="width: 100px;">
					<option value = "<?php echo $row['id_loja'];?>"><?php echo $row['loja'];?></option>
					
					<?php foreach ($var_loja as $loja) { ?>
						<option value = "<?php echo $loja['id'];?>"><?php echo $loja['loja'];?><?php  } ?></option>
				</select>
			</div>
			<div class="solicitante">
				<label>Solicitante</label><br>
				<input class="input" type="text" name="solicitante" required="" value="<?php echo $row['solicitante'];?>">
			</div>
			...
			<div class="prioridade">
				...
				<select name="id_prioridade" required="">
					<option value ="<?php echo $row['id_priori'];?>"><?php echo $row['prioridade'];?></option>
					
					<?php foreach($var_priore as $priore) { ?>
						<option value = "<?php echo $priore['id'];?>"><?php echo $priore['prioridade'];?></option>
					<?php } ?> 
				</select>
			...
			<!-- <div class="prioridade">
				...
				<select name="atendimento" required="">
					<option value="<?php echo $row['id_atendimento'];?>"><?php echo $row['descricao'];?></option>
			...
			<div class="status_chamado">
				...
				<select name="status_chamado" required="">
                    ...
                    <option value="6">Aguard-Peça</option>
                    <option value="7">Reaberto</option>
				</select>
			</div>
			<!-- <div class="data"> -->
				<!-- <label>Data Atual</label><br> -->
				<input class="input" type="hidden" readonly = "" name="atualizacao" value="<?php 
				date_default_timezone_set('America/Sao_Paulo');
				$date = date('d-m-Y H:i');
				echo $date;?>">
			<!-- </div> -->
			<div class="defeito_reclamado">
				...
				<textarea class ="input" rows="4" cols="5" maxlenght = "76"name="defeito_reclamado"><?php echo $row['reclamado'];?></textarea>
			</div>
			<div class="avaliacao_tecnico">
				<label>Avaliação Técnica</label><br>
				<input class="input" type="text" name="avaliacao" maxlenght = "100" value="<?php echo $row['avaliacao_tecnico'];?>">
			</div>
			<div class="mensagem">
				<label>Solução Técnica</label><br>
				<textarea class ="input" rows="4" cols="5" maxlength = "7500" name="solucao"><?php echo $row['solucao'];?></textarea>
			</div>
	<!-- INICIOL-->
	...
	<!-- fim INICIOL-->
			<div class="pendencia">
				...
				<input class="input" type="text" name="pendencia" placeholder="Pendenciacao técnica" maxlength="60" value="<?php echo$row['pendencia'];?>">
			</div>
			<div class="atendimento">
				<label>Atendimento</label><br>
				<select class="atend_select" required="" name="atendimento">
					<option value = "<?php echo $row['id_atendimento'];?>"><?php echo $row['descricao'];?></option>
					<option value="1">Externo</option>
			...
			<div class="botao_fechar">
				<input class = "button" type="submit" name=""  value="Confirmar">	
			</div>
		<?php }?>
	</form>
<!-- INICIO DO MODAL-->
